...
class HearingLocationMappingTest {
    ...
    void getHearingLocations_shouldReturnCorrespondingEpimsIdForVenue() {
        ...
        List<HearingLocation> result = HearingLocationMapping.getHearingLocations(caseData, referenceData);
        assertThat(result).hasSize(1);
        assertThat(result.get(0).getLocationId()).isEqualTo("9876");
        assertThat(result.get(0).getLocationType()).isEqualTo(LocationType.COURT);
    }
    ...
    void getMultipleHearingLocations() {
        ...
        if (!courtLocation.equalsIgnoreCase(result.get(0).getLocationType().getLocationLabel())) {
