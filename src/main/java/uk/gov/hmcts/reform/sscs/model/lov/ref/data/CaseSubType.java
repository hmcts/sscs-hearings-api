...
import static uk.gov.hmcts.reform.sscs.model.lov.ref.data.CaseType.*;
...
public enum CaseSubType {
    ...
    CaseSubType(String key, String value, CaseType caseType) {
        this.key = key;
        this.value = value;
    ...
    public static CaseSubType getCaseSubTypeBySubTypeValueAndCaseType(String value, CaseType caseType) {
        CaseSubType caseSubType = null;

        if (caseType != null) {
            for (CaseSubType ct : CaseSubType.values()) {
                if (ct.getCaseType().equals(caseType) && ct.getValue().equals(value)) {
                    caseSubType = ct;
                    break;
                }
            }
