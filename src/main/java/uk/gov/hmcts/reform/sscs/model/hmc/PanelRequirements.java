...
import static uk.gov.hmcts.reform.sscs.exceptions.ValidationError.AUTHORISATION_SUB_TYPE_MAX_LENGTH_MSG;
import static uk.gov.hmcts.reform.sscs.exceptions.ValidationError.PANEL_SPECIALISMS_MAX_LENGTH_MSG;
