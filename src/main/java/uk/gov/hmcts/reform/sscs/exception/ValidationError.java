...
public final class ValidationError {
    ...
    public static final String REQUEST_VERSION_NUMBER_NULL_EMPTY = "Request version number can not be empty";
    ...
    public static final String LIST_ASSIST_TRANSACTION_ID_NULL_EMPTY = "List Assist "
    ...
    public static final String HEARING_REQUEST_ID_MAX_LENGTH = "Hearing Request Id length cannot be "
        + "greater than 30 " + CHARACTERS_LONG;
    public static final String STATUS_MAX_LENGTH = "Status length cannot be greater than 30 " + CHARACTERS_LONG;
    public static final String HEARING_GROUP_REQUEST_ID_MAX_LENGTH = "Hearing Group Request Id length cannot be "
        + "greater than 30" + CHARACTERS_LONG;
    public static final String LIST_ASSIST_TRANSACTION_ID_MAX_LENGTH = "List Assist Transaction ID length cannot be "
        + "greater than 40" + CHARACTERS_LONG;
    public static final String HEARING_CANCELLATION_REASON_MAX_LENGTH = "Hearing Cancellation Reason length cannot be "
        + "greater than 40" + CHARACTERS_LONG;
    public static final String LIST_ASSIST_SESSION_ID_MAX_LENGTH = "List Assist Session Id length cannot be "
        + "greater than 60" + CHARACTERS_LONG;
    public static final String HEARING_VENUE_ID_MAX_LENGTH = "Hearing Venue Id length cannot be "
        + "greater than 60" + CHARACTERS_LONG;
    public static final String HEARING_ROOM_ID_MAX_LENGTH = "Hearing Room Id length cannot "
        + "be greater than 60" + CHARACTERS_LONG;
    public static final String HEARING_JUDGE_ID_MAX_LENGTH = "Hearing Judge Id length cannot"
        + " be greater than 60" + CHARACTERS_LONG;
    public static final String PANEL_MEMBER_ID_MAX_LENGTH = "Panel Member Id length cannot "
        + "be greater than 60" + CHARACTERS_LONG;
    public static final String PARTY_ID_LENGTH = "Party Id length cannot be greater than 40" + CHARACTERS_LONG;
    public static final String HEARING_SUB_CHANNEL_MAX_LENGTH = "Hearing Sub Channel length cannot be "
        + "greater than 60" + CHARACTERS_LONG;
